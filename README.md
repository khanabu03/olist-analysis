...
Data Cleaning / Preparation: - (i) Joining orders to order items via order_id (ii) Filtering delivered orders (iii) Calculated key metrics: Total Revenue = price + freight, Total Orders, Avg Revenue per Order
